...
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/blas-ext-base-dnannsumpw/tags). For example,

```javascript
dnannsumpw = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-dnannsumpw@v0.0.10-umd/browser.js' )
```
...
[test-image]: https://github.com/stdlib-js/blas-ext-base-dnannsumpw/actions/workflows/test.yml/badge.svg?branch=v0.0.10
[test-url]: https://github.com/stdlib-js/blas-ext-base-dnannsumpw/actions/workflows/test.yml?query=branch:v0.0.10
