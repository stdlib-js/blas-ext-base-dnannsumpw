...
var dnannsumpw = tryRequire( resolve( __dirname, './../lib/dnannsumpw.native.js' ) );
var opts = {
...
tape( 'the function has an arity of 5', opts, function test( t ) {
	t.strictEqual( dnannsumpw.length, 5, 'has expected arity' );
	t.end();
});
